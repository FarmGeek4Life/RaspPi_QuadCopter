...
class MultiWiiSP:
   ...
   ##send msp with no payload
   def requestFormatMSP(self, msp):  # int; return list<byte>
      if(msp < 0):
         return []
      bf = bytearray()
      for c in MultiWiiSP.MSP_HEADER:
   ...
   #MultiWiiSP.MSP_IDENT, MultiWiiSP.MSP_STATUS, MultiWiiSP.MSP_RAW_IMU, MultiWiiSP.MSP_SERVO, MultiWiiSP.MSP_MOTOR, MultiWiiSP.MSP_RC, MultiWiiSP.MSP_RAW_GPS, MultiWiiSP.MSP_COMP_GPS, MultiWiiSP.MSP_ATTITUDE, MultiWiiSP.MSP_ALTITUDE, MultiWiiSP.MSP_BAT, MultiWiiSP.MSP_RC_TUNING, MultiWiiSP.MSP_ACC_CALIBRATION, MultiWiiSP.MSP_MAG_CALIBRATION, MultiWiiSP.MSP_PID, MultiWiiSP.MSP_BOX, MultiWiiSP.MSP_BOXNAMES, MultiWiiSP.MSP_PIDNAMES, MultiWiiSP.MSP_MISC, MultiWiiSP.MSP_MOTOR_PINS, MultiWiiSP.MSP_DEBUGMSG, MultiWiiSP.MSP_DEBUG
