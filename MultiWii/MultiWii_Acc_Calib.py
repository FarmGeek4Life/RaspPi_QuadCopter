...
requests2=[MultiWii.MSP_ACC_CALIBRATION]

for k in range(0, 6):
   MultiWii.sendRequestMSP(MultiWii.requestsMSP(requests))
   
   if k == 5:
      MultiWii.sendRequestMSP(MultiWii.requestsMSP(requests2))
